...
int dir1X, dir1Y;
int target1; // 0 for apple1, 1 for apple2, 2 for apple3, 3 for apple4
int score1 = 0;
int totalScore1 = 0;
...
void versionInfo()
{
  ...
  tft.setTextSize(2);
  tft.println("Pet Snake Version 3.3.1");
  tft.println(" ");
  tft.println("Algorithm improvements");
  tft.println("More apples");
  tft.println("Logic improvments");
  tft.println(" ");
